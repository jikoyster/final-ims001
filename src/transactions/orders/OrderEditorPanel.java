 ...
 * @author Jake-LAPTOP
 */
public class OrderEditorPanel extends javax.swing.JPanel {
    ...
    private String supplierCode, supplierName;
    
    public boolean isUpdate = false;
    /**
     * Creates new form InvoiceEditorPanel
     */
    public OrderEditorPanel(Connection connection) {
        initComponents();
        ...
        try {
            ...
            Logger.getLogger(OrderEditorPanel.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//        System.out.println( "INVOICE DATE: "+displayDateFormat.format(date) );
    ...
    private void initComponents() {
        ...
        orderTF.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        ...
        supplierTF.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                supplierTFKeyReleased(evt);
            }
        });
        ...
        btn_setCustomer.setText("Supplier");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(orderTF, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(btn_setCustomer)
                    .addComponent(supplierTF, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(9, 9, 9)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    void update_table(){
        this.orderTable.getTableHeader().setFont(new Font("Tahoma", Font.BOLD, 16));
        ...
        this.orderTable.getColumnModel().getColumn(1).setCellRenderer(leftCol);
        this.orderTable.getColumnModel().getColumn(2).setCellRenderer(centerCol);
        this.orderTable.getColumnModel().getColumn(3).setCellRenderer(subtotalCol);
        this.orderTable.getColumnModel().getColumn(4).setCellRenderer(subtotalCol);
        
        
        this.orderTable.getColumnModel().getColumn(2).setPreferredWidth(5);
        
        this.orderTable.setModel(model);
        Functions.updateRowHeights(orderTable);
    }
    
    private void supplierTFKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_supplierTFKeyReleased
        // TODO add your handling code here:
    }//GEN-LAST:event_supplierTFKeyReleased
    ...
    private void btn_setCustomerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_setCustomerActionPerformed
        SetSupplierEditorPanel panel = new SetSupplierEditorPanel(this.conn);
        ...
        int returnVal = JOptionPane.showOptionDialog(null, panel, "Set Customer: ",
            ...
            null, options, null);
        if( returnVal == 0 ){
            this.supplierCode = panel.getSelectedSupplierCode();
            this.supplierName = panel.getSelectedSupplierName();
            this.supplierTF.setText( this.supplierName );
        }//if condition
    ...
    private void btn_removeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_removeActionPerformed
        ...
        if(result == JOptionPane.YES_OPTION){
            ...
            int[] srows = this.orderTable.getSelectedRows();
            DefaultTableModel model = (DefaultTableModel) this.orderTable.getModel();

            for( int i=0; i<srows.length; i++){
                if( this.isUpdate ){
                    //remove stocks from INVOICE_ITEMS table
                    String invoice  = this.orderTF.getText(),
                            code    = (String) this.orderTable.getValueAt(srows[i], 0);

                    String rmSql = "DELETE FROM "+this.tblOrderItems+" "
    ...
    public void setTotal(){
        ...
        for(int i=0; i<this.orderTable.getRowCount(); i++){
            total += Double.valueOf(String.valueOf(this.orderTable.getValueAt(i, 4)).replace(",", "")) ;
        }
    ...
    /***************** SETTERS ************************************/
    public void setOrderNumber(String invoiceNumber){
        this.orderTF.setText(invoiceNumber);
    }
    public void setCustomer(String customer){
        this.supplierTF.setText(customer);
    }
    ...
    public void setItems(String order){
        String sql = "SELECT * FROM "+this.tblOrderItems+", "+this.tblStocks+" "
                + "WHERE ORDER_REF='"+order+"' AND "+this.tblOrderItems+".CODE="+this.tblStocks+".CODE";
        try {
            DefaultTableModel model = (DefaultTableModel) this.orderTable.getModel();
            ...
            config.Functions.updateRowHeights(orderTable);
//            this.invoiceTable.setModel(model);
    ...
    public String getOrderNumber(){
        return this.orderTF.getText().toString();
    }
    public String getCustomer(){
        return this.supplierTF.getText().toString();
    }
    ...
    public int getOrderTableRows(){
        return this.orderTable.getRowCount();
    }
